...
from core.models import Produit, Stock, Entreprise, Boutique
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=100,
            help='Nombre de requêtes par utilisateur (défaut: 100)'
        )
    ...
    def test_load_performance(self, num_users, requests_per_user):
        ...
        async def simulate_user_requests(user_id):
            ...
            for i in range(requests_per_user):
                ...
                if i % 4 == 0:
                    # Requête produits
                    Produit.objects.filter(entreprise_id=1, actif=True)[:10]
                elif i % 4 == 1:
                    # Requête stocks
                    Stock.objects.filter(entrepot_id=1).select_related('produit')[:10]
                elif i % 4 == 2:
                    # Requête avec cache
